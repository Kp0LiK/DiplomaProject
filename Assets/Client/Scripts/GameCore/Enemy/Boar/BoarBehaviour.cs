...
{
    [SelectionBase]
    public class BoarBehaviour : MonoBehaviour, IEnemySwitchState, IDamageable
    {
        ...
        private void Start()
        {
            ...
            _states = new List<BaseEnemyState>
            {
                ...
                new BoarFollowState(_animator, this, _navMeshAgent, _playerDetector, _enemyData, this),
                new BoarAttackState(_animator, this, _enemyAttackDetector, _enemyData, this),
                new BoarNewAttackState(_animator, this, _enemyAttackDetector, _enemyData),
        ...
        private void OnSpiderAttackDetect()
        {
            ...
            {
                SwitchState<BoarNewAttackState>();
            }
        }
